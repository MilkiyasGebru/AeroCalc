...
export const useBuildingParameters = () => {
    ...
    let handleClick = ()=>{
        ...
        const [x,y]:number[] = CalculateFD(width, height, depth, meanSpeed, totalFloors, damping, GenerateFrequencies(initialFrequency, finalFrequency, deltaFrequency), across_psds, torsion_psds)
